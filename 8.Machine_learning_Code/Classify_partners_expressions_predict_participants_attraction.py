...
# 
# Based a three second interaction with social signals (smiles, eye fixations, etc.), we try to classify partner's attraction
...
# Dependent variable 
y = df_verbal['Part_Attraction'].values
